...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Bạn đã yêu cầu đổi mật khẩu tài khoản tại <strong>BỆNH VIỆN FOUR_ROCK</strong>.</p>
        ...
        <div class="footer">
            <p>&copy; <?php echo $currentYear; ?> BỆNH VIỆN FOUR_ROCK. Tất cả các quyền được bảo lưu.</p>
        </div>
    </div>
</body>
</html>